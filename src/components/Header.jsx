            ...
            <div className="container mx-auto flex items-center justify-between">
                ...
                >
                    ...
                    <nav className="space-y-4">
                        <Link to='/' className="hover:text-gray-200 transition duration-300 block cursor-pointer" onClick={closeMenu}>
                            Home
                        </Link>
                ...
                <div className="hidden md:flex md:items-center md:space-x-6">
                    <nav className="space-y-4 md:space-y-0 md:flex md:space-x-6">
                        <Link to='/' className="hover:text-gray-200 transition duration-300 block cursor-pointer">
                            Home
                        </Link>
                        ...
                        <a href="#donate" className="hover:text-gray-200 transition duration-300 block md:inline">
                            Donate
                        </a>
                    </nav>
                    <div className="space-y-4 md:space-y-0 md:flex md:space-x-4 mt-4 md:mt-0">
                        <Link to='/login' className="button primary px-4 py-2 rounded cursor-pointer">
                            Login
                        </Link>
                        <Link to='/register' className="button secondary px-4 py-2 rounded cursor-pointer">
                            Try for Free
                        </Link>
                    </div>
                </div>
